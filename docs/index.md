...
5. **Reacting to Changes** - [Why Polling](building-with-mvt/reacting-to-changes/why-polling.md), [Change Detection](building-with-mvt/reacting-to-changes/change-detection.md), [Deriving Values](building-with-mvt/reacting-to-changes/deriving-values.md), [Events and Signals](building-with-mvt/reacting-to-changes/events-and-signals.md)
