...
- [AGENTS.md](https://github.com/yortus/mvt-games/blob/main/AGENTS.md) - Concise AI agent orientation (architecture +
  conventions at a glance)
- [README.md](https://github.com/yortus/mvt-games/blob/main/README.md) - Project overview and quickstart
