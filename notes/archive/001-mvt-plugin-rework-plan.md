...
> swapped by section 11, and are now [the design notes](../../src/pixi-mvt/design-notes.md) and
...
[the design notes](../../src/pixi-mvt/design-notes.md); the benchmark numbers there
...
- Current README.md becomes **the design notes** (now `src/pixi-mvt/design-notes.md`). It is a good engineering log
