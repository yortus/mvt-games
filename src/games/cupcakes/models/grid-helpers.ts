...
export function findMatches(
    cells: DeepReadonly<CupcakeCell[][]>,
    rowCount: number,
    colCount: number,
): CupcakeCell[] {
...
/** Compact each column so cupcakes fall to fill gaps. Modifies `cells` in place. */
...
function kindAt(cell: CupcakeCell): CupcakeKind | undefined {
